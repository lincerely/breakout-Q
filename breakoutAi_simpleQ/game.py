...
class Breakout(object):
    ...
    def decision(self):
        ...
        actions = self.Q[(self.ball_x-self.paddle_x+640)/resolution,self.ball_y/resolution,:]
    ...
    def observe(self):
        ...
        self.Q[self.prev[0],self.prev[1],self.command] = (
            prev_Q + alpha * (self.current_reward + l *
                              max(self.Q[(self.ball_x-self.paddle_x+640)/resolution,self.ball_y/resolution,:])
                              - prev_Q))
